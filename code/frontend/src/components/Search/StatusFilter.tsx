...
const StatusFilter: FC<{ query: SearchQuery, setStatusFilter: Function }> = ({
  query,
  setStatusFilter
}) => {
  ...
  return (
    <div className="dropdown relative">
      ...
      <ul className={dropdownListFormatting} aria-labelledby="dropdownMenuButton1">
        <li>
          <a className={dropdownItemFormatting} onClick={() => setStatusFilter("Any Status")}>
            Any Status
          </a>
        </li>
        <hr className="h-0 my-2 border border-solid border-t-0 border-gray-700 opacity-25" />
        <li>
          <a className={dropdownItemFormatting} onClick={() => setStatusFilter("Reported")}>
            Reported
          </a>
        </li>
        <li>
          <a className={dropdownItemFormatting} onClick={() => setStatusFilter("In Progress")}>
            In Progress
          </a>
        </li>
        <li>
          <a className={dropdownItemFormatting} onClick={() => setStatusFilter("Completed")}>
            Completed
          </a>
        </li>
      </ul>
